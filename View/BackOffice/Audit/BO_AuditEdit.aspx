<%@ Page Title="" Language="C#" MasterPageFile="~/BO_MasterPage.Master" AutoEventWireup="true" CodeBehind="BO_AuditEdit.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.Audit.BO_AuditEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mt-3 ">Edit Audit</h2>
    <hr />
    <div class="row mb-4">
        <div class="col-md-6">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <asp:TextBox ID="dtBookingTime" CssClass="form-control border" runat="server" TextMode="DateTimeLocalLocal"></asp:TextBox>
    ...
    <div class="float-end">
        <asp:LinkButton ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-primary" CausesValidation="false" OnClientClick="JavaScript:window.history.back(1); return false;" />
