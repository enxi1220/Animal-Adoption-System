<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/BO_MasterPage.Master" CodeBehind="BO_UserActivate.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.User.BO_UserActivate" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mt-3 ">Activate Staff / Admin</h2>
    <hr />
    ...
    <div class="float-end">
        <asp:LinkButton ID="btnActivate1" runat="server" Text="Activate" CssClass="btn btn-primary ms-3" OnClick="btnActivate_Click" ></asp:LinkButton>
