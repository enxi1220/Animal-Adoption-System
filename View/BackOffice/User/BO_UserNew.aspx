<%@ Page Title="" Language="C#" MasterPageFile="~/BO_MasterPage.Master" AutoEventWireup="true" CodeBehind="BO_UserNew.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.User.BO_UserNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

        <h2 class="mt-3 ">Add Staff / Admin</h2>
    <hr />
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label  CssClass="form-label"  for="positionDdl">Position <asp:RequiredFieldValidator ID="rfvPosition" runat="server" style="margin-bottom:0.5em;" ControlToValidate="positionDdl" ErrorMessage="Please select a position" ForeColor="Red" Display="Dynamic" ValidationGroup="vg">*</asp:RequiredFieldValidator>  
                 ...
                 <asp:DropDownList ID="positionDdl" runat="server" CssClass="form-control border"  AppendDataBoundItems="true"  Height="2.5em">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <asp:CustomValidator ID="CustomValidator5" runat="server" ErrorMessage=""  ValidationGroup="vg" OnServerValidate="customValidator5_ServerValidate" Display="Dynamic" ForeColor="white" style="visibility: hidden;"></asp:CustomValidator>
    ...
    <div style="float:right; margin-top:3em; margin-bottom:3em;">
        <asp:LinkButton ID="btnCancel3" runat="server" Text="Cancel" CssClass="btn btn-primary"  CausesValidation="False" OnClick="btnCancel_Click" ></asp:LinkButton>
        <%--<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary ms-3" ValidationGroup="vg" OnCommand="btnSave3_Click"/>--%>
        <asp:LinkButton ID="btnSave"  CssClass="btn btn-primary ms-3" ValidationGroup="vg" OnClick="btnSave3_Click" runat="server">Save</asp:LinkButton>
