<%@ Page Title="" Language="C#" MasterPageFile="~/BO_MasterPage.Master" AutoEventWireup="true" CodeBehind="BO_UserView.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.User.BO_UserView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mt-3 ">View Staff / Admin</h2>
    <hr />
    ...
    <div style="float:right; margin-left:96em; margin-bottom:3em;">
        <asp:LinkButton ID="btnBack2" runat="server" Text="Back" CssClass="btn btn-primary ms-3"  OnClientClick="JavaScript:window.history.back(1); return false;" ></asp:LinkButton>
    </div>
