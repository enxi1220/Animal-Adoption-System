<%@ Page Title="" Language="C#" MasterPageFile="~/BO_MasterPage.Master" AutoEventWireup="true" CodeBehind="BO_PetActivate.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.Pet.BO_PetActivate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mt-3 ">Activate Pet</h2>
    <hr />
    ...
    <div class="float-end mb-5">
        ...
        <asp:LinkButton ID="btnActivate" runat="server" Text="Activate" CssClass="btn btn-primary" OnClick="btnActivate_Click" />
    </div>
    </div>
