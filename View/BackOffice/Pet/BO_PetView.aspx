<%@ Page Title="" Language="C#" MasterPageFile="~/BO_MasterPage.Master" AutoEventWireup="true" CodeBehind="BO_PetView.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.Pet.BO_PetView" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mt-3 ">View Pet</h2>
    <hr />
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="form-group">
                <label class="form-label" for="petImg">Pet Image</label>
                <br />
                 <asp:Image ID="petImg" style="height:380px; width:600px; object-fit: scale-down;" runat="server"/>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="float-end mb-5">
        <asp:LinkButton ID="btnBack" runat="server" Text="Back" CssClass="btn btn-primary ms-3" OnClick="btnBack_Click" />
