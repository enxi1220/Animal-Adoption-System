<%@ Page Title="" Language="C#" MasterPageFile="~/BO_MasterPage.Master" AutoEventWireup="true" CodeBehind="BO_PetEdit.aspx.cs" Inherits="AnimalAdoptionSystem.View.BackOffice.Pet.BO_PetEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mt-3 ">Edit Pet</h2>
    <hr />
    <div class="row mb-4">
        <div class="col-md-6">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <asp:TextBox ID="auditPeriodTxt" runat="server" CssClass="form-control border" MaxLength="9999" min="1"></asp:TextBox>
                <asp:RequiredFieldValidator
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <asp:Image ID="petImgEdit" style="height:380px; width:600px; object-fit: scale-down;" runat="server" Visible="False" />
            </div>
        </div>
    </div>
